    ...
    <header className="md:my-32 my-20">
      <section className="flex flex-col-reverse md:flex-row justify-between items-center gap-5">
        <div className="flex flex-col mt-5 gap-3 md:w-7/12">
          <h1 className="font-bold leading-[38px] md:leading-[45px] lg:leading-[60px] text-[25px] md:text-[30px] lg:text-[48px] max-w-[540px}">Let us Transform your sustainability journey.</h1>
          <p className="md:text-[20px]" >Reduce your environmental impact by using a scientific data-driven approach and restore damage.</p>
          <button className="btn-primary py-4 md:py-6 h-[48px] w-full md:w-fit">Contact Us</button>
        </div>
        <figure className="md:w-5/12">
         <div className="grayscale-0 transition-filter duration-300 sm:w-6/12 mx-auto md:w-11/12 md:ml-auto block relative z-10">
          <Image src="/heroImage.jpg" alt="hero-img " width={500} height={500}   />
         </div>
        </figure>
      </section>
      <div>
